...
for n_obj=length(obj.OUT.Objects):-1:1
	switch obj.OUT.data{n_obj}.type
		case 1
			[Sx,~,~,~,Ey,Ez,~,Hy,Hz] = Poynting(obj,obj.OUT.data{n_obj}.X,obj.OUT.data{n_obj}.Y,obj.OUT.data{n_obj}.Z);
            obj.OUT.data{n_obj}.Hy(:,:,time)	= squeeze(Hy);
            obj.OUT.data{n_obj}.Hz(:,:,time)	= squeeze(Hz);
            obj.OUT.data{n_obj}.Ey(:,:,time)	= squeeze(Ey);
            obj.OUT.data{n_obj}.Ez(:,:,time)	= squeeze(Ez);
		...
		case 2
		   [~,Sy,~,Ex,~,Ez,Hx,~,Hz] = Poynting(obj,obj.OUT.data{n_obj}.X,obj.OUT.data{n_obj}.Y,obj.OUT.data{n_obj}.Z);
            obj.OUT.data{n_obj}.Hx(:,:,time)	= squeeze(Hx);
            obj.OUT.data{n_obj}.Hz(:,:,time)	= squeeze(Hz);
            obj.OUT.data{n_obj}.Ex(:,:,time)	= squeeze(Ex);
            obj.OUT.data{n_obj}.Ez(:,:,time)	= squeeze(Ez);
		...
		case 3
			[~,~,Sz,Ex,Ey,~,Hx,Hy,~] = Poynting(obj,obj.OUT.data{n_obj}.X,obj.OUT.data{n_obj}.Y,obj.OUT.data{n_obj}.Z);
